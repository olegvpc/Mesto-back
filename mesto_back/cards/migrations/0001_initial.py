# Generated by Django 3.2 on 2022-07-23 22:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Жак-Ив-Кусто', max_length=64)),
                ('about', models.CharField(default='Исследователь', max_length=64)),
                ('avatar', models.CharField(blank=True, max_length=64, null=True)),
                ('cohort', models.CharField(blank=True, default='cohort-45', max_length=64)),
        ...
        migrations.AddField(
            model_name='card',
            name='likes',
            field=models.ManyToManyField(through='cards.Like', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='card',
            name='owner',
